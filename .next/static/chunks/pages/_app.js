...
/* harmony import */ var _slices_cartSlice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../slices/cartSlice */ "./src/slices/cartSlice.js");
...
var cartSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createSlice)({
  ...
  reducers: {
    ...
    removeFromCart: function removeFromCart(state, action) {
      var index = state.items.findIndex(function (cartItem) {
        return cartItem.id === action.payload.id;
      });

      var newCart = (0,C_Users_rajath_Documents_aaaProjects_Amazon_clone_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(state.items);
...
var _cartSlice$actions = cartSlice.actions,
    ...
    removeFromCart = _cartSlice$actions.removeFromCart; // Selectors - This is how we pull information from the Global store slice
